...
import GoalItem from "../components/ProjectItem.js";

import GoalInput from "../components/ProjectInput.js";
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.container}>
        <Image source={require("../assets/project.jpg")} style={styles.image} />
      </View>
